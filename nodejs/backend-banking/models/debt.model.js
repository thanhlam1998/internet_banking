...
module.exports = {
  ...
  get_list_debt: customer_id => db.load(`SELECT debt.*, credit_account.credit_number FROM debt INNER JOIN credit_account ON debt.lender_id=credit_account.customer_id WHERE debt.lender_id=${customer_id} AND debt.status=1`),
